...
| ----------------- | -------------- | ------------------------ |
| **Processamento** | CPU, GPU       | Executa instruções       |
| **Memória**       | RAM            | Armazena dados temp/perm |
| **Armazenamento** | HD, SSD        | Guarda arquivos          |
| **Entrada**       | Teclado, Mouse | Recebe dados do usuário  |
| **Saída**         | Monitor        | Mostra resultado         |
| **Comunicação**   | Roteador/Modem | Conecta à internet       |
| **Energia**       | Bateria        | Alimenta componentes     |
| **Suporte**       | Não sei        | Estrutura e integridade  |
## Software
